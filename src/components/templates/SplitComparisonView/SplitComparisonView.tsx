...
import { SyncActions } from "../ComparisonView/SyncActions";
    ...
    <div className="flex flex-col flex-1 min-h-0 gap-3">
      ...
      <div className="flex items-center gap-3 bg-bg-secondary border border-border rounded-2xl px-5 py-3 shrink-0">
        ...
        <div className="flex-1 flex items-center gap-2 min-w-0 overflow-hidden text-[11px]">
          ...
          <span className="text-text-tertiary uppercase text-[10px] font-medium tracking-widest shrink-0">Target</span>
          <span className="text-text-secondary font-medium overflow-hidden text-ellipsis whitespace-nowrap">
            {targetPath}
          </span>
        </div>
        ...
        <div className="flex-1 overflow-y-auto bg-bg-secondary border border-border rounded-2xl min-h-0">
          ...
          <div className="sticky top-0 z-10 grid grid-cols-[1fr_24px_1fr] bg-bg-card border-b border-border">
            <div className="flex items-center gap-2 px-4 py-2">
              ...
              <span className="text-[10px] text-text-tertiary w-14 text-right">Size</span>
            </div>
            <div className="bg-bg-primary/50 border-x border-border-subtle" />
            <div className="flex items-center gap-2 px-3 py-2">
              <span className="text-[10px] font-medium text-text-tertiary uppercase tracking-widest">Target</span>
              <div className="flex-1" />
              <span className="text-[10px] text-text-tertiary w-14 text-right">Size</span>
            </div>
          </div>
