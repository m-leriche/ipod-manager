...
// The split tree is virtualized; @tanstack/react-virtual measures via
// offsetHeight, which jsdom reports as 0. Give the scroll container a viewport
// height and each row a fixed height (and fire ResizeObserver) so rows render.
beforeEach(() => {
