...
const ENTRIES = [
  { relative_path: "Artist1/song1.mp3", is_dir: false, source_size: 5000, target_size: null, source_modified: 1700000000, target_modified: null, status: "source_only" as const },
  { relative_path: "Artist1/song2.mp3", is_dir: false, source_size: 6000, target_size: 6000, source_modified: 1700000000, target_modified: 1700000000, status: "same" as const },
  { relative_path: "Artist2/track1.mp3", is_dir: false, source_size: 4000, target_size: 3500, source_modified: 1700002000, target_modified: 1700000000, status: "modified" as const },
  { relative_path: "old/removed.mp3", is_dir: false, source_size: null, target_size: 3000, source_modified: null, target_modified: 1700000000, status: "target_only" as const },
];
