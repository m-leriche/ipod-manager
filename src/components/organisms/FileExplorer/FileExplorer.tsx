...
import type { FileEntry, FileExplorerProps, ContextMenuState } from "./types";
...
export const FileExplorer = ({
  ...
  const reload = useCallback(() => load(path), [path]);
                ...
                return (
                  <tr
                    ...
                    className={`transition-colors group cursor-default ${
                      rowSelected ? "bg-accent/10" : "hover:bg-bg-hover/50"
                    } ${rowCut ? "opacity-50" : ""}`}
